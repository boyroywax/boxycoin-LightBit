...
{
    const char* pszTimestamp = "BOXYCoin.PoW";
...
public:
    CMainParams() {
        ...
        consensus.powLimit = uint256S("00fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        ...
        genesis = CreateGenesisBlock(1612033497, 5127, 0x1f0fffff, 1, 85 * COIN);
        // consensus.hashGenesisBdmlock = // calculate Genesis Block
        // Reset genesis
...
//                     LogPrintf("Calculating Mainnet Genesis Block:\n");
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,8); // 4
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1565128501, 339318, 0x1e3fffff, 1, 85 * COIN);
