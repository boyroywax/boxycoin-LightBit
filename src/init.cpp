...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/boxycoinproject/boxycoin>";
    const std::string URL_WEBSITE = "<https://boxycoin.tech>";
